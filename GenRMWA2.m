function [beta_loc,theta,len_c_tra,len_d_tra,len_t_tra,plane_p,hmw3]=GenRMWA2(x0,y0,z0,dx,dy,dz,joint_c,j_dd_dip,hm,rmc,mwdy,mwdx,mw_dd_dip)
...
plane_p=[];
for i=1:col
	[angle,np1,np2,is_jmw_flag]=IsJointMWInsect(joint_c(:,i),j_dd_dip(:,i),hm(i),p_cn1,p_cn2,mw_dd_dip);
	if is_jmw_flag==1
...
nrec_cn1=nrec_cn1+[-mwdx;mwdy;0];
nrec_cn2=nrec_cn2+[-mwdx;mwdy;0];
nrec_cn3=nrec_cn3+[-mwdx;mwdy;0];
nrec_cn4=nrec_cn4+[-mwdx;mwdy;0];
%rotate 90 degree around z-axis
...
line([nrec_cn1(1,1),nrec_cn2(1,1)],[nrec_cn1(2,1),nrec_cn2(2,1)],[nrec_cn1(3,1),nrec_cn2(3,1)]);
line([nrec_cn2(1,1),nrec_cn3(1,1)],[nrec_cn2(2,1),nrec_cn3(2,1)],[nrec_cn2(3,1),nrec_cn3(3,1)]);
line([nrec_cn3(1,1),nrec_cn4(1,1)],[nrec_cn3(2,1),nrec_cn4(2,1)],[nrec_cn3(3,1),nrec_cn4(3,1)]);
line([nrec_cn4(1,1),nrec_cn1(1,1)],[nrec_cn4(2,1),nrec_cn1(2,1)],[nrec_cn4(3,1),nrec_cn1(3,1)]);
...
if col~=0
    ...
    colort=[0,0,0]; 
	for i=1:col
		line(([t_tra(1,i),t_tra(4,i)]),([t_tra(2,i),t_tra(5,i)]),([t_tra(3,i),t_tra(6,i)]),'Color',colort,'LineWidth',1);
    end
end
...
if col~=0
    ...
    colort=[0,0.8,0];
	for i=1:col
		line(([d_tra(1,i),d_tra(4,i)]),([d_tra(2,i),d_tra(5,i)]),([d_tra(3,i),d_tra(6,i)]),'Color',colort,'LineWidth',1);
    end
end
